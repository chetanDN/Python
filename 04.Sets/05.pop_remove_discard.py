...
Ugh, input().split() will produce list with entered values, i.e. ['remove', '5'] or ['pop']. adding a list with empty value will ensure that there are always 2 elements in list, at least.
